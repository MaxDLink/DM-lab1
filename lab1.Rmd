...
texas_cases_with_30_60_Growth_Rate <- texas_cases |>
  group_by(county_name) |>
  mutate(
...
summary(texas_cases_with_30_60_Growth_Rate)
...
```{r}
# add growth rate to our dataset 
# Load dplyr if not already loaded
library(dplyr)

# Join tx_data with the growth rate columns from texas_cases_with_30_60_Growth_Rate
tx_data_with_gr <- tx_data %>%
  left_join(texas_cases_with_30_60_Growth_Rate, by = "county_name")
