...
We do not have to change any of the other values. The mobility percentages are already numeric and normalized. Geographic identifiers are categorical. Date is temporal.

We can merge this .csv with the other two datasets later on. 
...
Date_Updated --> convert to a proper date format for timer series analysis/merging. We can do weekly totals or Rolling Averages 

County_name --> standardize & ensure consistency for merging with other .csvs

state --> standardize & ensure consistency for merging with other .csvs 

county_fips_code --> standardize & ensure consistency for merging with other .csvs. Use county_fips code as primary key for geographic joins. county_fips compatible with U.S. country level data

state_fips_Code --> standardize & ensure consistency for merging with other .csvs 

keep or drop: state & state_fips_code 

cases & deaths --> aggregation? standardization/rates, outlier detection, scaling/standardization for models? 
...
Date --> convert to proper date for time series 

Geographic identifier: 

Country_fips_code --> standardize & check consistency for merging 

County_name --> standardize & check consistency for merging  

state --> standardize & check consistency for merging  
